# This code is used to send data to Unity
...
import io
import socket
from MicCheck import list_microphones, check_microphone_active
...
# Highly recommend to run the MicCheck.py first to get the desired microphone input index and check if it is activated
mic_index = 1
if not check_microphone_active(mic_index):
    print(f"Microphone at index {mic_index} is not active.")
    exit()

# TCP SOCKET COMMUNICATION
server = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
serverAddPort = ("10.0.0.93", 60021)
